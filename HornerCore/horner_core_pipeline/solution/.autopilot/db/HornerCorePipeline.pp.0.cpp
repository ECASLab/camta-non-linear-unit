...
# 10 "C:/Xilinx/Vitis_HLS/2023.2/common/technology/autopilot\\ap_fixed.h" 2
...
__attribute__((sdx_kernel("horner_core_pipeline", 0))) data_t horner_core_pipeline(
    data_t x,
    data_t a3,
    data_t a2,
    data_t a1,
...
#pragma HLSDIRECTIVE TOP name=horner_core_pipeline
# 11 "./HornerCorePipeline.cpp"
