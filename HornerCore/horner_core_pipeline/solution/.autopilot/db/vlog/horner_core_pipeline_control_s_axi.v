...
// ==============================================================
`timescale 1ns/1ps
module horner_core_pipeline_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_X_DATA_0    = 6'h18,
    ADDR_X_CTRL      = 6'h1c,
    ADDR_A3_DATA_0   = 6'h20,
    ADDR_A3_CTRL     = 6'h24,
    ADDR_A2_DATA_0   = 6'h28,
    ADDR_A2_CTRL     = 6'h2c,
    ADDR_A1_DATA_0   = 6'h30,
    ADDR_A1_CTRL     = 6'h34,
    ADDR_A0_DATA_0   = 6'h38,
    ADDR_A0_CTRL     = 6'h3c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_A3_DATA_0)
            int_a3[15:0] <= (WDATA[31:0] & wmask) | (int_a3[15:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_A2_DATA_0)
            int_a2[15:0] <= (WDATA[31:0] & wmask) | (int_a2[15:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_A1_DATA_0)
            int_a1[15:0] <= (WDATA[31:0] & wmask) | (int_a1[15:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_A0_DATA_0)
            int_a0[15:0] <= (WDATA[31:0] & wmask) | (int_a0[15:0] & ~wmask);
    end
end
